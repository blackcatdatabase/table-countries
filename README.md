...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 0 outbound / 2 inbound · ✅ No engine drift detected · Index coverage: todo · PII: none · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\countries](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\countries)
...
graph LR
  ...
  countries["countries"]:::center
  tax_rates["tax_rates"]:::inbound -->|FK| countries
  vat_validations["vat_validations"]:::inbound -->|FK| countries
...
- Inbound (relies on this): "tax_rates", "vat_validations"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package countries -Apply
