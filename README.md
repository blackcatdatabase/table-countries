...
> Lineage: 0 outbound / 2 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 0 · Changelog: fresh (0 d)
...
| Pkg folder | [packages\countries](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\countries) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package countries -Apply
