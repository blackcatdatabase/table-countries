...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'iso2', 'name', 'created_at', 'updated_at' ];
    }
...
protected function sortable(): array
{
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\Countries\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\Countries\Definitions::softDeleteColumn();
