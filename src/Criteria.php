 ...
 * - whitelist filtrů: [ 'iso2', 'name' ]
 * - whitelist pro LIKE hledání: [ 'iso2', 'name' ]
 */
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'iso2', 'name' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'iso2', 'name' ], true);
            $parts = [];
