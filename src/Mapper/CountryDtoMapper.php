...
namespace BlackCat\Database\Packages\Countries\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO CountryDto:
...
final class CountryDtoMapper
{
     ...
     * @return CountryDto
     */
    public static function fromRow(array $row): CountryDto
    {
        /** @var CountryDto */
    ...
    public static function fromRowOrNull(?array $row): ?CountryDto
    {
     ...
     */
    public static function toRow(CountryDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(CountryDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(CountryDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(CountryDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,CountryDto>
     */
