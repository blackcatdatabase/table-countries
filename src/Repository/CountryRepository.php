...
final class CountryRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`countries`' : '"countries"';
     ...
     * [ 'iso2' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'name' ] = které sloupce aktualizovat.
     */
